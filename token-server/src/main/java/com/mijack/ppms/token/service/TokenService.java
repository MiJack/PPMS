...
public interface TokenService {
     ...
     * @return 生成的邀请token
     */
    GeneratedToken generateToken(TokenGenerateDto tokenGenerateDto);
     ...
     */
    TokenGenerateDto reverseToken(Token token);
     ...
     * @return 生成的权限
     */
    GeneratedToken extendTokenExpireTime(Token token, long expireDuration);
